...
BLOG_AUTHOR = "David Garcia Guerrero"  # (translatable)
BLOG_TITLE = "My English Site"  # (translatable)
...
BLOG_EMAIL = "miemailito@gmail.com"
BLOG_DESCRIPTION = "My notes about english learning"  # (translatable)
